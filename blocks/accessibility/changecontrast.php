...
/**
 * Cambia el color de fondo y el color del texto via PHP or AJAX                               (1)
 *
 *                                                                     (2)
 *
 * @package   block_accessibility                                      (3)
 * @author      Angela Castro Jimenez
 * @copyright   2019, UGR, Granada                                      (4)
...
$op = required_param('option', PARAM_TEXT);
if($op == "reset"){
    unset($USER->colourfondo);
    unset($USER->colourletra);
    ...
    $colorFondo = required_param('colorFondo', PARAM_TEXT);
    $colorLetra = required_param('colorLetra', PARAM_TEXT);
    $USER->colourfondo = $colorFondo;
    $USER->colourletra = $colorLetra;
